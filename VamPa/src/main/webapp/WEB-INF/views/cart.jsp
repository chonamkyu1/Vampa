...
<div class="wrapper">
	<div class="wrap">
		...
		<div class="content_area">
			...
			<!-- 장바구니 리스트 -->
			<div class="content_middel_section"></div>
			<!-- 장바구니 가격 합계 -->
			<!-- cartInfo -->
						...
						<c:forEach items="${cartInfo }" var="ci">
							<tr>
								...
								<td class="td_width_4 price_td">
									<del>정가 : <fmt:formatNumber value="${ci.bookPrice }" pattern="#,### 원"></fmt:formatNumber></del><br>
									판매가 : <span class="red_color"><fmt:formatNumber value="${ci.salePrice }" pattern="#,### 원"></fmt:formatNumber></span><br>
									마일리지 : <span class="green_color"><fmt:formatNumber value="${ci.point }" pattern="#,### 원"></fmt:formatNumber></span>
								</td>
								...
								<td class="td_width_4 table_text_align_center">
									<fmt:formatNumber value="${ci.salePrice * ci.bookCount }"  pattern="#,### 원"></fmt:formatNumber>
								</td>
								<td class="td_width_4 table_text_align_center">
...
<!-- 										<td>총 주문 상품수</td> -->
<!-- 										<td> -->
<!-- 											<span class="totalKind_span"></span>종 <span class="totalCount_span"></span>권 -->
<!-- 										</td> -->
<!-- 									</tr> -->
<!-- 								</table> -->
<!-- 							</td> -->
...
<script>
	...
	$(".all_check_input").on("click", function(){
		...
		// 총 주문 정보 세팅(배송피, 총가격, 마일리지, 물품 수, 종류, 최종 가격)
		setTotalInfo($(".cart_info_td"));
	});
...
// 				console.log("totalCount : ", totalCount);
				...
				// 총 종류
				totalKind += 1;
// 				console.log("totalKind : ", totalKind);
