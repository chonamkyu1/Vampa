...
<!-- 							<div class="reply_top"> -->
<!-- 								<span class="id_span">sjinsjin7</span> -->
<!-- 								<span class="date_span">2022-07-25</span> -->
...
<!-- 									사실 기대를 많이하고 읽기 시작했는데 읽으면서 가가 쓴것이 맞는지 의심들게 합니다. 문체도 그렇고 간결하지 않네요. 제가 기대가 크던 작았던간에 책장이 사실 안념겨집니다. -->
<!-- 								</div> -->
<!-- 							</div> -->
<!-- 						</div> -->
<!-- 					</li> -->
...
// 		console.log("bobj", bobj);
	...
	function makeReplyContent(obj) {
		if (obj.list.length === 0 ) { 				// 리플이 없는 경우
			...
			$(list).each(function(i, obj){
				...
				reply_list += 			'<span class="id_span">' + obj.memberId + '</span>'; 			// id
				...
				reply_list += 		'</div>';
				reply_list +=		'<div class="reply_buttom">';
				reply_list += 			'<div class="reply_buttom_txt">' + obj.content + '</div>';
				reply_list +=		'</div>';
				reply_list +=	'</div>';
				reply_list += '</li>';
			});
	...
	$(".btn_cart").on("click", function(){
		...
		console.log("form.bookCount : ", form.bookCount);
