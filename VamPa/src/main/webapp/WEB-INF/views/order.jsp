							...
							<table>
								...
								<tbody>
									...
									<tr>
										<th>주소</th>
										<td>
											${memberInfo.memberAddr1 } ${memberInfo.memberAddr2 } <br>
								...
								<tbody>
									...
									<tr>
										...
										<td>
											...
											<input class="address1_input" readonly="readonly"><a class="address_search_btn" onclick="execution_daum_address()">주소찾기</a><br>
							...
							<c:forEach items="${orderList }" var="ol">
								<tr>
									...
									<td class="goods_table_price_td">
										<fmt:formatNumber value="${ol.salePrice }" pattern="#,### 원"></fmt:formatNumber> | 수량 ${ol.bookCount }개
										<br><fmt:formatNumber value="${ol.totalPrice }" pattern="#,### 원"></fmt:formatNumber>
										<br>[<fmt:formatNumber value="${ol.totalPoint }" pattern="#,### 원"></fmt:formatNumber>P]
...
<script>
	...
	$(".order_point_input").on("propertychange change keyup paste input", function(){
		...
		const maxPoint = parseInt('${memberInfo.point}'); //parseInt
...
// 		console.log("finalTotalPrice 포인트 사용 전 : ", finalTotalPrice);
		
		/* 사용 포인트 */
		usePoint = $(".order_point_input").val();
		
		finalTotalPrice = totalPrice - usePoint;
// 		console.log("finalTotalPrice 포인트 사용 후: ", finalTotalPrice);
