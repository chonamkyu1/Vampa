...
// 		console.log("cate1Array : ", cate1Array); // 티어별로 다시 나눔
...
// 		console.log("cate3Array : ", cate3Array);
 ...
 <script>
	...
	console.log("rawDiscountRate : ", rawDiscountRate);
