...
<body>
 ...
 <script>
	$(document).ready(function(){
		...
		console.log("bookDiscount : ", bookDiscount);
...
// 				console.log(editor);
		...
		$(".cate3 option").each(function(i, obj) {   // selected 속성 추가 코드
...
// 				console.log("obj", obj);
		...
		$(".cate2 option").each(function(i, obj) {   // selected 속성 추가 코드
		...
		// ------------------------------------------
		/* 이미지 정보 호출 */
		let bookId = '<c:out value="${goodsInfo.bookId}" />'; // 서버로부터 전달받은 bookId를 값을 갖는 변수 
